...
public class Ngram
{
    ...
    public String getNgrams(String entity, int ngramsize, Ngram ngram)
    {
    	String ngrams="";
    	for (result r : ngram.processString(entity, ngramsize))
    	{
    		ngrams=ngrams+" "+r.theWord;
    	}
    	return ngrams;
    }
    public static void main(String args[])
    {
    	...
    	for (result r : ngram.processString("Western Michigan University", 3))
    	{
        	System.out.println(r.theWord);
    	}
    	System.out.println(ngram.getNgrams("Anuj Saini", 3, ngram));
    }
}